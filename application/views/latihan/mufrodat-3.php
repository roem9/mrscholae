...
<script>
    ...
    $(".hapus").click(function(){
        ...
        } else if(answer.charAt(answer.length-1) == "ا" || answer.charAt(answer.length-1) == "ى" || answer.charAt(answer.length-1) == "-" || answer.charAt(answer.length-1) == "ل" || answer.charAt(answer.length-1) == "آ"){
